 ...
 * Bootstrapping Class
 * 
 * 1. 스프링 부트 애플리케이션의 부트스트랩핑(Bootstrapping) 2. 설정 클래스로 역할(Configuration Class)
 * 
 *
 */
